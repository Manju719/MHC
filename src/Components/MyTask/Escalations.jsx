...
import {data} from './EscalationData'
          ...
          <tbody>
                  {
                    ...
                    <td className='text-md text-left truncate px-2 py-3 w-[14%] '><div className='font-semibold '>{ele.Doctor}</div></td>
                        ...
                        <td className='text-md text-left truncate px-2 py-3 w-[14%]'><div className='font-semibold'>{ele.specialty}</div></td>
                        <td className='text-md text-left truncate px-2 py-3 w-[14%]'><div className='text-red-600 font-bold'>{ele.Degree}</div></td>
                        ...
                        <td className='text-md text-left truncate px-2 py-3 w-[14%]'><div className='font-semibold'>{ele.DOJ}</div></td>
