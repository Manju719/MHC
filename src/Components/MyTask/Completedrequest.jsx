          ...
          <tbody>
                  {
                    ...
                    <td className='text-md text-left truncate px-2 py-3 w-[14%]'><div className='font-semibold'>{ele.Doctor}</div></td>
                        ...
                        <td className='text-md text-left truncate px-2 py-3 w-[14%]'><div className='text-green-600 font-semibold'>{ele.Degree}</div></td>
                        <td className='text-md text-left truncate px-2  py-3 w-[14%]'><div className=' rounded-3xl'><div className='ml-1 mt-1 font-semibold'>
                        <span>
                                {
