...
<div class="ml-2 md:ml-0 max-w-xs relative p-2">
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead>
                <tr>
                  ...
                  <th scope="col" class="px-3 py-3  text-lg font-semibold text-black bg-[#FAFAFA]"><div className='flex'>Assigned&nbsp;To<div className='flex ml-2 mt-1 text-lg'> <div><PiCaretUpDown/></div> <div><span className='ml-2 font-semibold'></span></div></div></div></th>
              ...
              <tbody className='text-[#2B3674]'>
                      {
                        ...
                        <td className='text-md text-left truncate px-2 py-3 w-[14%]'><div className='font-semibold'>{ele.Ticket_ID}</div></td>
                            <td className='text-md text-left truncate px-2 py-3 w-[14%]'>
                              <div className='flex font-semibold'> 
          
                                <span>
                                  {
                                    ele.color==='g' ? <> <span className='flex gap-4'><BsStarFill fill='green' className='mt-1 '/>{ele.Employee_name}</span></>
                                    : ele.color=== 'y' ? <><span className='flex gap-4'><BsStarFill fill='yellow' className='mt-1 '/>{ele.Employee_name}</span></>
                                    : <><span className='flex gap-4'><BsStarFill fill='gray' className='mt-1 '/>{ele.Employee_name}</span></>
                                  }
                                
                                </span></div></td>
                            <td className='text-md text-left truncate px-2 py-3 w-[14%]'><div className='font-semibold'>{ele.Area_of_problem}</div></td>
                            <td className='text-md text-left truncate px-2 py-3 w-[14%]'><div className='text-green-600'>{ele.Request_type}</div></td>
                            <td className='text-md text-left truncate px-2  py-3 w-[14%]'><div className=' rounded-3xl'><div className='ml-1 mt-1'>
                            <span>
                                    {
                                        ele.prior===1 ? <span className='text-[#ff0023] border rounded-3xl w-24 py-1 px-2 text-center inline-block  border-[#ff0023]'>{ele.Priority}</span>
                                        : ele.prior ===2 ? <span className='text-[#2c2c2c] rounded-3xl w-24 py-1 px-2 text-center inline-block  border border-[#2c2c2c] '>{ele.Priority}</span>
                                        :ele.prior ===3 ? <span className='text-[#ff8a00] border-[#ff8a00] rounded-3xl w-24 py-1 px-2 text-center inline-block  border'>{ele.Priority}</span>
                                        :<span className='text-slate'>{}</span>
                                    }
                                </span>
                                </div></div></td>
                            <td className='text-md text-left truncate px-2 py-3 w-[14%]'><div className='font-semibold'>{ele.assigned_to}</div></td>
    ...
    {/* //below */}
            <div className='flex justify-between'>
             ...
             <div className='flex'>
             <div><div className='mt-8 ml-10'><BsChevronLeft/></div></div>
