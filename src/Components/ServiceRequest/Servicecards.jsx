...
const FourBoxes = () => {
  return (
    <div className='w-[98.9%] ml-4 rounded-lg shadow-sm '>

      

      {/* <!-- Card Sectiona --> */}
<div class="w-full  px-4 py-10 sm:px-6 lg:px-4 lg:py-10 mx-auto ">
  {/* <!-- Grid --> */}
  <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6 -mt-12">
    {/* <!-- Card --> */}
    <a class="group flex flex-col flex-wrap bg-white  hover:shadow-md transition border-l-8 border-l-purple-300 rounded-2xl shadow-lg" href="#">
          ...
          <div class="flex items-center">
            ...
            <div class="ml-5">
              <h3 class="group-hover:text-blue-600 font-semibold text-gray-800  dark:text-gray-200">
               <span className='text-3xl  font-semibold'>180</span><br></br><span className='tracking-widest text-slate-500'>Total Request</span> <br></br><span className='tracking-widest text-slate-500'>raised</span>
              </h3>
            </div>
          </div>
          <div class="pl-3">
    ...
    {/* <!-- Card --> */}
    <a class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition border-l-8 border-l-purple-300 rounded-2xl shadow-lg" href="#">
      <div class="p-4 md:p-5">
        <div class="flex justify-between items-center">
          <div class="flex items-center mt-3">
